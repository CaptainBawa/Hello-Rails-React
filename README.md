...
**Hello React-Rails** A Rails app that serves a React front-end, which displays a random greeting from a list of greetings. The app would be built using the following technologies: Ruby on Rails, React, Redux and PostgreSQL
...
```sh
  cd my-folder
  git clone git@github.com:CaptainBawa/Hello-Rails-React.git
```
...
Feel free to check the [issues page](https://github.com/CaptainBawa/Hello-Rails-React/issues).
...
This project is [MIT](https://github.com/CaptainBawa/Hello-Rails-React/blob/development/LICENSE) licensed.
